...
class DClabShell(Cmd):
    config = []
    config_loc = "/home/ubuntu/dclab-source/config/dclab/test_config.json"
    ...
    def do_run(self, inp):
        ...
        os.system("/home/ubuntu/onos-2.1.0/bin/onos-app 127.0.0.1 uninstall org.onosproject.dclab")
        time.sleep(1)
        os.system("/home/ubuntu/onos-2.1.0/bin/onos-app 127.0.0.1 reinstall! ~/dclab-source/dclab/target/onos-app-dclab-2.1.0.oar ")
